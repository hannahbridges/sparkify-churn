...
This is a binary classification problem aiming to predict which users will cancel their subscription so that Sparkify can attempt 
to provide offers or discounts to encourage them to stay.
